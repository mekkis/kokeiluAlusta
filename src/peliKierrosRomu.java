 ...
 */
public class peliKierrosRomu¨ {

    int nopanSilmaluku = 0;
    peliNappulaRomu pylpyra = new peliNappulaRomu("");
    String nappulanVari = "";
    int m = 0;
    int nappulaLkm = 1;
    ...
    public void alustaPelaaja(String pelaajanVari, int nappulanNumero) {
        pylpyra = new peliNappulaRomu(pelaajanVari);
    ...
    public void pelaajaHeittaaNoppaaKerran() {
        nopanHeittoRomu heitto = new nopanHeittoRomu();
